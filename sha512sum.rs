...
impl W {
    ...
    fn F(&mut self, state: &mut State, i: usize, k: u64) {
        ...
        t[(16 - i + 7) & 7] = t[(16 - i + 7) & 7]
            ...
            .wrapping_add(Self::Ch(t[(16 - i + 4) & 7], t[(16 - i + 5) & 7], t[(16 - i + 6) & 7]))
            .wrapping_add(k)
            .wrapping_add(self.0[i]);
        t[(16 - i + 3) & 7] = t[(16 - i + 3) & 7].wrapping_add(t[(16 - i + 7) & 7]);
        t[(16 - i + 7) & 7] = t[(16 - i + 7) & 7]
            .wrapping_add(Self::Sigma0(t[(16 - i) & 7]))
            .wrapping_add(Self::Maj(t[(16 - i) & 7], t[(16 - i + 1) & 7], t[(16 - i + 2) & 7]));
    }
...
impl State {
    ...
    fn add(&mut self, x: &State) {
        for i in 0..8 {
            self.0[i] = self.0[i].wrapping_add(x.0[i]);
        }
    }
