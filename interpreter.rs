        ...
        let functions: Vec<(&str, &str)> = vec![
            ...
            (
                ...
                r#"{
                    ...
                    "example": "let db = db_open(\"mydata.db\")"
                }"#
            ),
            (
                "db_close",
            ...
            (
                ...
                r#"{
                    ...
                    "example": "let result = db_query(db, \"SELECT * FROM users WHERE name = ?\", [\"Alice\"])"
                }"#
            ),
            (
                "db_execute_params",
                r#"{
                    ...
                    "example": "let affected = db_execute_params(db, \"INSERT INTO users (name) VALUES (?)\", [\"Alice\"])"
                }"#
            ),
            (
                "db_last_insert_id",
                r#"{
                    ...
                    "example": "let new_id = db_last_insert_id(db)"
                }"#
            ),
            (
                "db_error",
